...
config.network = "r100"
config.resume = False
config.output = "/output/merged_ms1m_glint_r100_subcenter_dropped"
...
config.rec = "/datasets/merged_ms1m_glint_rec_drop75"
config.num_classes = 453663
config.num_image = 22262335
config.num_epoch = 30
...
config.suffix_run_name = "merged_ms1m_glint_r100_subcenter_dropped_try"
config.notes = "Training r100 on merged MS1MV3 + Glint360K dataset with subcenter dropped"
